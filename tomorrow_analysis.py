# Tomorrow's AI surf analysis with caching
...
def get_tomorrow_hourly_forecast():
    """Extract tomorrow's hourly forecast data with intelligent caching"""
    try:
        ...
        return get_tomorrow_forecast_data()

def get_tomorrow_forecast_data():
    """Get tomorrow's forecast by running existing scripts"""
    try:
        # Get the current Python executable path
        import sys
        python_exe = sys.executable
        
        # Run both beach scripts to get tomorrow's conditions
...
def generate_tomorrow_analysis():
    """Generate AI analysis for tomorrow's surf conditions"""
    try:
        # Get hourly forecast data
        forecast_data = get_tomorrow_hourly_forecast()
        ...
        tomorrow = date.today() + timedelta(days=1)
        user_input = f"""
**Tomorrow's Surf Forecast - {tomorrow.strftime('%A, %B %d')}**
...
"""
        ...
        system_prompt = """
You are a professional surf coach analyzing tomorrow's surf conditions in Sydney.
...
TOMORROW'S SURF OVERVIEW - [Day, Month Date]
...
"""
        ...
        # Save to cache file
        with open("tomorrow_analysis.json", "w") as f:
            json.dump(analysis, f, indent=4, ensure_ascii=False)
            f.write('\n')
        
        print("Tomorrow's AI analysis generated and cached")
        return analysis
        
    except Exception as e:
        print(f"Error generating tomorrow's analysis: {e}")
        raise e

def get_cached_tomorrow_analysis():
    """Get tomorrow's analysis from cache, generate if not exists or outdated"""
    try:
            ...
            try:
                ...
                if "last_updated" in wave_data:
                    ...
                    if wave_updated > analysis_generated:
                        ...
                        return generate_tomorrow_analysis()
...
if __name__ == "__main__":
    ...
    analysis = generate_tomorrow_analysis()
    print("\n" + "="*50)
    print("TOMORROW'S AI SURF ANALYSIS")
    print("="*50)
